...
## OpenHands asset destinations

Choose exactly one destination:
- shareable product prompt: `skills/<name>.md`, following `skills/README.md`;
- repository-private V1 instruction: `.openhands/skills/<name>.md`;
- repository-private V0 compatibility instruction: `.openhands/microagents/<name>.md`.

These are different systems. Do not place a product prompt in a private instruction directory, and do not invent `.agents/skills` for this repository.
